...
#ifndef RADIO_1st_CONFIG_H_
#define RADIO_1st_CONFIG_H_
...
// RF_1st Freq.(MHz): 490    API_TC: 29    fhst: 25000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
...
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_XO_FREQ                     {30000000L}
#define RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER                    {0x00}
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH               {0x01}
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP        {0x03}
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET       {0xF000}


// CONFIGURATION COMMANDS

/*
// Command:                  RF_1st_POWER_UP
// Description:              Command to power-up the device and select the operational mode and functionality.
*/
#define RF_1st_POWER_UP 0x02, 0x01, 0x00, 0x01, 0xC9, 0xC3, 0x80

/*
// Command:                  RF_1st_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_1st_GPIO_PIN_CFG 0x13, 0x21, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_GLOBAL_XO_TUNE_1
...
*/
#ifdef F_BOARD
#define RF_1st_GLOBAL_XO_TUNE_1 0x11, 0x00, 0x01, 0x00, 0x38
#else
#define RF_1st_GLOBAL_XO_TUNE_1 0x11, 0x00, 0x01, 0x00, 0x46
#endif
/*
// Set properties:           RF_1st_GLOBAL_CONFIG_1
// Number of properties:     1
// Group ID:                 0x00
// Start ID:                 0x03
// Default values:           0x20, 
...
*/
#define RF_1st_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x60

/*
// Set properties:           RF_1st_INT_CTL_ENABLE_2
...
*/
//#define RF_1st_INT_CTL_ENABLE_2 0x11, 0x01, 0x02, 0x00, 0x01, 0x38
#define RF_1st_INT_CTL_ENABLE_3 0x11, 0x01, 0x03, 0x00, 0x03, 0x38, 0x01

/*
// Set properties:           RF_1st_FRR_CTL_A_MODE_4
...
*/
#define RF_1st_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x0A, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_PREAMBLE_TX_LENGTH_9
...
*/
//#define RF_1st_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x04, 0x0A, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00
#define RF_1st_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x03, 0x08, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_SYNC_CONFIG_5
...
*/
#define RF_1st_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x01, 0xB4, 0x2B, 0x00, 0x00

/*
// Set properties:           RF_1st_PKT_CRC_CONFIG_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x00
// Default values:           0x00, 
...
*/
#define RF_1st_PKT_CRC_CONFIG_1 0x11, 0x12, 0x01, 0x00, 0x80

/*
// Set properties:           RF_1st_PKT_WHT_SEED_15_8_4
// Number of properties:     4
// Group ID:                 0x12
// Start ID:                 0x03
...
*/
#define RF_1st_PKT_WHT_SEED_15_8_4 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x02

/*
// Set properties:           RF_1st_PKT_LEN_12
...
*/
#define RF_1st_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x01, 0x06, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_PKT_FIELD_2_CRC_CONFIG_12
// Number of properties:     12
// Group ID:                 0x12
// Start ID:                 0x14
...
*/
#define RF_1st_PKT_FIELD_2_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_PKT_FIELD_5_CRC_CONFIG_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x20
// Default values:           0x00, 
...
*/
#define RF_1st_PKT_FIELD_5_CRC_CONFIG_1 0x11, 0x12, 0x01, 0x20, 0x00

/*
// Set properties:           RF_1st_MODEM_MOD_TYPE_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x00
...
*/
#define RF_1st_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x00, 0x27, 0x10, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00

/*
// Set properties:           RF_1st_MODEM_FREQ_DEV_0_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x0C
// Default values:           0xD3, 
...
*/
#define RF_1st_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0x46

/*
// Set properties:           RF_1st_MODEM_TX_RAMP_DELAY_8
...
*/
#define RF_1st_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xF0, 0x11

/*
// Set properties:           RF_1st_MODEM_BCR_OSR_1_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x22
...
*/
#define RF_1st_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x02, 0x71, 0x00, 0xD1, 0xB7, 0x00, 0x69, 0x02, 0xC2

/*
// Set properties:           RF_1st_MODEM_AFC_GEAR_7
...
*/
#define RF_1st_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0xC0, 0x01, 0x11, 0x96, 0xC0

/*
// Set properties:           RF_1st_MODEM_AGC_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x35
// Default values:           0xE0, 
...
*/
#define RF_1st_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE2

/*
// Set properties:           RF_1st_MODEM_AGC_WINDOW_SIZE_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x38
...
//   MODEM_AGC_RF_1stPD_DECAY - Sets the decay time of the RF_1st peak detectors.
...
*/
#define RF_1st_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x89, 0x89, 0x00, 0x1A, 0xFF, 0xFF, 0x00, 0x2B

/*
// Set properties:           RF_1st_MODEM_OOK_CNT1_11
...
*/
//#define RF_1st_MODEM_OOK_CNT1_11 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xD0, 0x01, 0x80, 0xFF, 0x0C, 0x00
#define RF_1st_MODEM_OOK_CNT1_11 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xD0, 0x01, 0x80, 0xFF, 0x0C, 0x02
/*
// Set properties:           RF_1st_MODEM_RSSI_COMP_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x4E
// Default values:           0x40, 
...
*/
//#define RF_1st_MODEM_RSSI_COMP_1 0x11, 0x20, 0x01, 0x4E, 0x3A
#define RF_1st_MODEM_RSSI_COMP_1 0x11, 0x20, 0x01, 0x4E, 0x3A

/*
// Set properties:           RF_1st_MODEM_CLKGEN_BAND_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x51
// Default values:           0x08, 
...
*/
#define RF_1st_MODEM_CLKGEN_BAND_1 0x11, 0x20, 0x01, 0x51, 0x0A

/*
// Set properties:           RF_1st_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x00
...
*/
#define RF_1st_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0x7E, 0x64, 0x1B, 0xBA, 0x58, 0x0B, 0xDD, 0xCE, 0xD6, 0xE6, 0xF6, 0x00

/*
// Set properties:           RF_1st_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x0C
...
*/
#define RF_1st_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x03, 0x03, 0x15, 0xF0, 0x3F, 0x00, 0x23, 0x17, 0xF4, 0xC2, 0x88, 0x50

/*
// Set properties:           RF_1st_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x18
...
*/
#define RF_1st_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0x21, 0xFF, 0xEC, 0xE6, 0xE8, 0xEE, 0xF6, 0xFB, 0x05, 0xC0, 0xFF, 0x0F

/*
// Set properties:           RF_1st_PA_MODE_4
// Number of properties:     4
// Group ID:                 0x22
// Start ID:                 0x00
...
*/
#define RF_1st_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, GLOBAL_PASET, 0x00, 0x3D

/*
// Set properties:           RF_1st_SYNTH_PFDCP_CPFF_7
// Number of properties:     7
// Group ID:                 0x23
// Start ID:                 0x00
...
*/
#define RF_1st_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03

/*
// Set properties:           RF_1st_MATCH_VALUE_1_12
// Number of properties:     12
// Group ID:                 0x30
// Start ID:                 0x00
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
*/
#define RF_1st_MATCH_VALUE_1_12 0x11, 0x30, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_1st_FREQ_CONTROL_INTE_8
// Number of properties:     8
// Group ID:                 0x40
// Start ID:                 0x00
...
#define RADIO_1st_CONFIGURATION_DATA_ARRAY { \
        0x07, RF_1st_POWER_UP, \
        0x08, RF_1st_GPIO_PIN_CFG, \
        0x05, RF_1st_GLOBAL_XO_TUNE_1, \
        0x05, RF_1st_GLOBAL_CONFIG_1, \
        0x07, RF_1st_INT_CTL_ENABLE_3, \
        0x08, RF_1st_FRR_CTL_A_MODE_4, \
        0x0D, RF_1st_PREAMBLE_TX_LENGTH_9, \
        0x09, RF_1st_SYNC_CONFIG_5, \
        0x05, RF_1st_PKT_CRC_CONFIG_1, \
        0x08, RF_1st_PKT_WHT_SEED_15_8_4, \
        0x10, RF_1st_PKT_LEN_12, \
        0x10, RF_1st_PKT_FIELD_2_CRC_CONFIG_12, \
        0x05, RF_1st_PKT_FIELD_5_CRC_CONFIG_1, \
        0x10, RF_1st_MODEM_MOD_TYPE_12, \
        0x05, RF_1st_MODEM_FREQ_DEV_0_1, \
        0x0C, RF_1st_MODEM_TX_RAMP_DELAY_8, \
        0x0D, RF_1st_MODEM_BCR_OSR_1_9, \
        0x0B, RF_1st_MODEM_AFC_GEAR_7, \
        0x05, RF_1st_MODEM_AGC_CONTROL_1, \
        0x0D, RF_1st_MODEM_AGC_WINDOW_SIZE_9, \
        0x0F, RF_1st_MODEM_OOK_CNT1_11, \
        0x05, RF_1st_MODEM_RSSI_COMP_1, \
        0x05, RF_1st_MODEM_CLKGEN_BAND_1, \
        0x10, RF_1st_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_1st_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_1st_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x0B, RF_1st_SYNTH_PFDCP_CPFF_7, \
        0x10, RF_1st_MATCH_VALUE_1_12, \
        0x00 \
 }
#else
#define RADIO_1st_CONFIGURATION_DATA_ARRAY { 0 }
#endif

// DEFAULT VALUES FOR CONFIGURATION PARAMETERS
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_XO_FREQ_DEFAULT                     30000000L
#define RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT                    0x00
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH_DEFAULT               0x10
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP_DEFAULT        0x01
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET_DEFAULT       0x1000

#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PATCH_INCLUDED                      0x00
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PATCH_SIZE                          0x00
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PATCH                               {  }

#ifndef RADIO_1st_CONFIGURATION_DATA_ARRAY
#error "This property must be defined!"
#endif

#ifndef RADIO_1st_CONFIGURATION_DATA_RADIO_1st_XO_FREQ
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_XO_FREQ         { RADIO_1st_CONFIGURATION_DATA_RADIO_1st_XO_FREQ_DEFAULT }
#endif

#ifndef RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER
#define RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER        { RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER_DEFAULT }
#endif

#ifndef RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH   { RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH_DEFAULT }
#endif

#ifndef RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP  { RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP_DEFAULT }
#endif

#ifndef RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET
#define RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET { RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET_DEFAULT }
#endif

#define RADIO_1st_CONFIGURATION_DATA { \
                            Radio_1st_Configuration_Data_Array,                            \
                            RADIO_1st_CONFIGURATION_DATA_CHANNEL_NUMBER,                   \
                            RADIO_1st_CONFIGURATION_DATA_RADIO_1st_PACKET_LENGTH,              \
                            RADIO_1st_CONFIGURATION_DATA_RADIO_1st_STATE_AFTER_POWER_UP,       \
                            RADIO_1st_CONFIGURATION_DATA_RADIO_1st_DELAY_CNT_AFTER_RESET       \
                            }

#endif /* RADIO_1st_CONFIG_H_ */
