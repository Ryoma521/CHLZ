...
#define ZB_CC2530_FIFO_TAIL 2 /* crc, rssi */ //We should verify at SI44XX slolution. Ryoma
 ...
 */
/* should be checked */
#define ZB_START_NORMAL_FIFO_TX(retries, need_ack) MAC_CTX().tx_cnt = 0 //Ryoma
...
void zb_si44xx_handler(void); //Ryoma  
...
#ifndef ZB_SNIFFER
void zb_si4463_fifo_write(zb_uint16_t long_addr, zb_buf_t *buf) ZB_SDCC_REENTRANT; //Ryoma
#endif
...
#define ZB_CLEAR_ISRSTS() //(RFIRQF0 =0, S1CON = 0, RFIRQF1 = 0); //Ryoma
