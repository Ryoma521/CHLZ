...
#define ZB_8051_IDLE() //(PCON |= 0x01, PCON = PCON) Ryoma
#define ZB_FORCE_IDLE() ZB_8051_IDLE()
#else
#define ZB_8051_IDLE() //(PCON = PCON) Ryoma
#define ZB_FORCE_IDLE() //(PCON |= 0x01, PCON = PCON) Ryoma
#endif
...
#define ZB_ENABLE_ALL_INTER() //(EA = 1) Ryoma
#define ZB_DISABLE_ALL_INTER() //(EA = 0, EA = 0) Ryoma
...
#define ZB_START_DEVICE() ZB_ENABLE_ALL_INTER() //Ryoma
