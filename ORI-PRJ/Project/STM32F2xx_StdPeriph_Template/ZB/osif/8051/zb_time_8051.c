...
//#pragma vector=TIMER0_INTER_NUMBER //Ryoma
#endif
//ZB_INTERRUPT timer0_inter_handler(void) INTERRUPT_DECLARATION(TIMER0_INTER_NUMBER, REGISTER_BANK_2) //Ryoma

void timer0_inter_handler(void)
{
  ZB_TIMER_CTX().timer++;
