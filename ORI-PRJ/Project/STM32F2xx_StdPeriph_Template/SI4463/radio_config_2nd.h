...
// MOD_type: 3    Rsymb(sps): 2500    Fdev(Hz): 2500    RXBW(Hz): 11000    Manchester: 0    AFC_en: 1    Rsymb_error: 0.0    Chip-Version: 2    
// RF_2nd Freq.(MHz): 465    API_TC: 29    fhst: 25000    inputBW: 1    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # WB filter 3 (BW =  11.58 kHz);  NB-filter 7 (BW = 7.56 kHz) 
...
#define RADIO_2nd_CONFIGURATION_DATA_RADIO_2nd_PACKET_LENGTH               {0x18}
...
/*
// Command:                  RF_2nd_POWER_UP
// Description:              Command to power-up the device and select the operational mode and functionality.
*/
#define RF_2nd_POWER_UP 0x02, 0x01, 0x00, 0x01, 0xC9, 0xC3, 0x80

/*
// Command:                  RF_2nd_GPIO_PIN_CFG
// Description:              Configures the GPIO pins.
*/
#define RF_2nd_GPIO_PIN_CFG 0x13, 0x21, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_GLOBAL_XO_TUNE_1
...
*/
#define RF_2nd_GLOBAL_XO_TUNE_1 0x11, 0x00, 0x01, 0x00, 0x46

/*
// Set properties:           RF_2nd_GLOBAL_CONFIG_1
// Number of properties:     1
// Group ID:                 0x00
// Start ID:                 0x03
// Default values:           0x20, 
...
*/
#define RF_2nd_GLOBAL_CONFIG_1 0x11, 0x00, 0x01, 0x03, 0x60

/*
// Set properties:           RF_2nd_INT_CTL_ENABLE_2
...
*/
#define RF_2nd_INT_CTL_ENABLE_2 0x11, 0x01, 0x02, 0x00, 0x01, 0x38

/*
// Set properties:           RF_2nd_FRR_CTL_A_MODE_4
...
*/
#define RF_2nd_FRR_CTL_A_MODE_4 0x11, 0x02, 0x04, 0x00, 0x0A, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_PREAMBLE_TX_LENGTH_9
...
*/
#define RF_2nd_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x11, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_SYNC_CONFIG_5
...
*/
#define RF_2nd_SYNC_CONFIG_5 0x11, 0x11, 0x05, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_PKT_CRC_CONFIG_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x00
// Default values:           0x00, 
...
*/
#define RF_2nd_PKT_CRC_CONFIG_1 0x11, 0x12, 0x01, 0x00, 0x80

/*
// Set properties:           RF_2nd_PKT_WHT_SEED_15_8_4
// Number of properties:     4
// Group ID:                 0x12
// Start ID:                 0x03
...
*/
#define RF_2nd_PKT_WHT_SEED_15_8_4 0x11, 0x12, 0x04, 0x03, 0xFF, 0xFF, 0x00, 0x02

/*
// Set properties:           RF_2nd_PKT_LEN_12
...
*/
#define RF_2nd_PKT_LEN_12 0x11, 0x12, 0x0C, 0x08, 0x00, 0x00, 0x00, 0x30, 0x30, 0x00, 0x18, 0x04, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_PKT_FIELD_2_CRC_CONFIG_12
// Number of properties:     12
// Group ID:                 0x12
// Start ID:                 0x14
...
*/
#define RF_2nd_PKT_FIELD_2_CRC_CONFIG_12 0x11, 0x12, 0x0C, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_PKT_FIELD_5_CRC_CONFIG_1
// Number of properties:     1
// Group ID:                 0x12
// Start ID:                 0x20
// Default values:           0x00, 
...
*/
#define RF_2nd_PKT_FIELD_5_CRC_CONFIG_1 0x11, 0x12, 0x01, 0x20, 0x00

/*
// Set properties:           RF_2nd_MODEM_MOD_TYPE_12
// Number of properties:     12
// Group ID:                 0x20
// Start ID:                 0x00
...
*/
#define RF_2nd_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x01, 0x86, 0xA0, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x00

/*
// Set properties:           RF_2nd_MODEM_FREQ_DEV_0_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x0C
// Default values:           0xD3, 
...
*/
#define RF_2nd_MODEM_FREQ_DEV_0_1 0x11, 0x20, 0x01, 0x0C, 0xAF

/*
// Set properties:           RF_2nd_MODEM_TX_RAMP_DELAY_8
...
*/
#define RF_2nd_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0xB0, 0x20

/*
// Set properties:           RF_2nd_MODEM_BCR_OSR_1_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x22
...
*/
#define RF_2nd_MODEM_BCR_OSR_1_9 0x11, 0x20, 0x09, 0x22, 0x00, 0xBC, 0x02, 0xBB, 0x0D, 0x01, 0x5D, 0x02, 0xC2

/*
// Set properties:           RF_2nd_MODEM_AFC_GEAR_7
...
*/
#define RF_2nd_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0xC0, 0x07, 0x09, 0x65, 0xC0

/*
// Set properties:           RF_2nd_MODEM_AGC_CONTROL_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x35
// Default values:           0xE0, 
...
*/
#define RF_2nd_MODEM_AGC_CONTROL_1 0x11, 0x20, 0x01, 0x35, 0xE2

/*
// Set properties:           RF_2nd_MODEM_AGC_WINDOW_SIZE_9
// Number of properties:     9
// Group ID:                 0x20
// Start ID:                 0x38
...
//   MODEM_AGC_RF_2ndPD_DECAY - Sets the decay time of the RF_2nd peak detectors.
...
*/
#define RF_2nd_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0x29, 0x29, 0x00, 0x1A, 0x80, 0x00, 0x00, 0x29

/*
// Set properties:           RF_2nd_MODEM_OOK_CNT1_11
...
*/
#define RF_2nd_MODEM_OOK_CNT1_11 0x11, 0x20, 0x0B, 0x42, 0xA4, 0x02, 0xD6, 0x83, 0x00, 0xAD, 0x01, 0x80, 0xFF, 0x0C, 0x00

/*
// Set properties:           RF_2nd_MODEM_RSSI_COMP_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x4E
// Default values:           0x40, 
...
*/
#define RF_2nd_MODEM_RSSI_COMP_1 0x11, 0x20, 0x01, 0x4E, 0x40

/*
// Set properties:           RF_2nd_MODEM_CLKGEN_BAND_1
// Number of properties:     1
// Group ID:                 0x20
// Start ID:                 0x51
// Default values:           0x08, 
...
*/
#define RF_2nd_MODEM_CLKGEN_BAND_1 0x11, 0x20, 0x01, 0x51, 0x0A

/*
// Set properties:           RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x00
...
*/
#define RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12 0x11, 0x21, 0x0C, 0x00, 0xCC, 0xA1, 0x30, 0xA0, 0x21, 0xD1, 0xB9, 0xC9, 0xEA, 0x05, 0x12, 0x11

/*
// Set properties:           RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x0C
...
*/
#define RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12 0x11, 0x21, 0x0C, 0x0C, 0x0A, 0x04, 0x15, 0xFC, 0x03, 0x00, 0x39, 0x2B, 0x00, 0xC3, 0x7F, 0x3F

/*
// Set properties:           RF_2nd_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12
// Number of properties:     12
// Group ID:                 0x21
// Start ID:                 0x18
...
*/
#define RF_2nd_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12 0x11, 0x21, 0x0C, 0x18, 0x0C, 0xEC, 0xDC, 0xDC, 0xE3, 0xED, 0xF6, 0xFD, 0x15, 0xC0, 0xFF, 0x0F

/*
// Set properties:           RF_2nd_PA_MODE_4
// Number of properties:     4
// Group ID:                 0x22
// Start ID:                 0x00
...
*/
#define RF_2nd_PA_MODE_4 0x11, 0x22, 0x04, 0x00, 0x08, 0x0A, 0x00, 0x3D

/*
// Set properties:           RF_2nd_SYNTH_PFDCP_CPFF_7
// Number of properties:     7
// Group ID:                 0x23
// Start ID:                 0x00
...
*/
#define RF_2nd_SYNTH_PFDCP_CPFF_7 0x11, 0x23, 0x07, 0x00, 0x2C, 0x0E, 0x0B, 0x04, 0x0C, 0x73, 0x03

/*
// Set properties:           RF_2nd_MATCH_VALUE_1_12
// Number of properties:     12
// Group ID:                 0x30
// Start ID:                 0x00
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
*/
#define RF_2nd_MATCH_VALUE_1_12 0x11, 0x30, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00

/*
// Set properties:           RF_2nd_FREQ_CONTROL_INTE_8
// Number of properties:     8
// Group ID:                 0x40
// Start ID:                 0x00
...
*/
#define RF_2nd_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x3D, 0x08, 0x00, 0x00, 0x06, 0xD4, 0x20, 0xFE
...
#define RADIO_2nd_CONFIGURATION_DATA_ARRAY { \
        0x07, RF_2nd_POWER_UP, \
        0x08, RF_2nd_GPIO_PIN_CFG, \
        0x05, RF_2nd_GLOBAL_XO_TUNE_1, \
        0x05, RF_2nd_GLOBAL_CONFIG_1, \
        0x06, RF_2nd_INT_CTL_ENABLE_2, \
        0x08, RF_2nd_FRR_CTL_A_MODE_4, \
        0x0D, RF_2nd_PREAMBLE_TX_LENGTH_9, \
        0x09, RF_2nd_SYNC_CONFIG_5, \
        0x05, RF_2nd_PKT_CRC_CONFIG_1, \
        0x08, RF_2nd_PKT_WHT_SEED_15_8_4, \
        0x10, RF_2nd_PKT_LEN_12, \
        0x10, RF_2nd_PKT_FIELD_2_CRC_CONFIG_12, \
        0x05, RF_2nd_PKT_FIELD_5_CRC_CONFIG_1, \
        0x10, RF_2nd_MODEM_MOD_TYPE_12, \
        0x05, RF_2nd_MODEM_FREQ_DEV_0_1, \
        0x0C, RF_2nd_MODEM_TX_RAMP_DELAY_8, \
        0x0D, RF_2nd_MODEM_BCR_OSR_1_9, \
        0x0B, RF_2nd_MODEM_AFC_GEAR_7, \
        0x05, RF_2nd_MODEM_AGC_CONTROL_1, \
        0x0D, RF_2nd_MODEM_AGC_WINDOW_SIZE_9, \
        0x0F, RF_2nd_MODEM_OOK_CNT1_11, \
        0x05, RF_2nd_MODEM_RSSI_COMP_1, \
        0x05, RF_2nd_MODEM_CLKGEN_BAND_1, \
        0x10, RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, \
        0x10, RF_2nd_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, \
        0x10, RF_2nd_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, \
        0x08, RF_2nd_PA_MODE_4, \
        0x0B, RF_2nd_SYNTH_PFDCP_CPFF_7, \
        0x10, RF_2nd_MATCH_VALUE_1_12, \
        0x0C, RF_2nd_FREQ_CONTROL_INTE_8, \
        0x00 \
 }
#else
#define RADIO_2nd_CONFIGURATION_DATA_ARRAY { 0 }
#endif
...
#ifndef RADIO_2nd_CONFIGURATION_DATA_ARRAY
